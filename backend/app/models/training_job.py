...
class TrainingJob(Base):
    ...
    current_model_index: Mapped[int | None] = mapped_column(Integer, nullable=True)
    total_models: Mapped[int | None] = mapped_column(Integer, nullable=True)
    current_model_progress: Mapped[int | None] = mapped_column(Integer, nullable=True)
